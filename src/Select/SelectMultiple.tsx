...
import { classWithModifiers, toggleState } from "utils"
...
function SelectMultiple<V extends {} = string>(props: SelectMultipleProps<V>) {
  ...
  return (
    <div className="select" style={{ "--select-width": props.width }} ref={parentRef}>
      ...
      <button className={classWithModifiers("select__appearance", props.size)} type="button" onClick={toggleState(setExpanded)}>
